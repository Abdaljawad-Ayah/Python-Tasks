...
# guset = input("PLease Enter Your Name :")
# guset = input("Enter your Seat Number :")

# total = 0
# for i in range(len(guset)):
#     total = total + 1

# print("Total Number of Characters in the string =", total)

# Excercise Seven
# Using the in operator, check whether a Letter or symbol is a part of Word or not